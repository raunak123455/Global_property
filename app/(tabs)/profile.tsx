        ...
        <Card style={styles.profileCard}>
          <View style={styles.profileHeader}>
            ...
            <View style={styles.profileInfo}>
              ...
              {user && (
                <Text style={styles.userRole}>Role: {displayUser.role.charAt(0).toUpperCase() + displayUser.role.slice(1)}</Text>
              )}
              <Text style={styles.memberSince}>Member since {displayUser.memberSince}</Text>
            </View>
          </View>
          <CustomButton
            title="Edit Profile"
